...
import { SignUpInfo } from 'src/app/model/signupRequest.model';
...
export class AuthService {
  ...
  signUp(info: SignUpInfo): Observable<SignUpInfo> {
    return this.http.post<SignUpInfo>(this.signup_url, info, httpOptions);
  }
}
